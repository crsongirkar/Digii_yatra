...
const FlightResult: React.FC<FlightResultProps> = ({ flight, onSelect }) => (
  <Paper
    sx={{
      width: '150%',
      maxWidth: 1000, // Increased width for the card
      margin: '0 auto',
      p: 3,
      mb: 3,
...
export const SearchFlight = () => {
  ...
  const backgroundStyle = {
    background: `linear-gradient(rgba(0, 0, 0, 0.30), rgba(0, 0, 0, 0.3)), url('/flight-background.jpg')`,
      ...
      <SearchContainer>
        ...
        {showResults && (
          ...
          >
            ...
            {isLoading ? (
              <Box sx={{ display: 'flex', justifyContent: 'center', my: 41 }}>
