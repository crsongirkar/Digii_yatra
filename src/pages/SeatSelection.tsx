            ...
            <React.Fragment key={seatId}>
              <motion.button
                ...
                className={clsx(
                  ...
                  isSelected && 'bg-pink-200 text-red border-primary hover:border-primary',
      ...
      <div className="max-w-4xl mx-auto py-8">
        <div className="p-6">
          {/* <div className="text-center mb-8">
            <h1 className="text-4xl font-bold mb-2">Select 2 Seats</h1>
            <br />
          </div> */}
          <Typography 
            variant="h3" 
          ...
          <div className="flex justify-between mb-8">
            <button
              ...
              className="bg-blue-300 items-center gap-13 border border-black-300 p-2 rounded"
            >
              Previous
            </button>
            <button
              onClick={handleNext}
              className="bg-blue-300 items-center gap-2 border border-black-300 p-2 rounded"
